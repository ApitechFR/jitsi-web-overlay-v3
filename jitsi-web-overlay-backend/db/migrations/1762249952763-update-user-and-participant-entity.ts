...
export class UpdateUserAndParticipantEntity1762249952763 implements MigrationInterface {
    name = 'UpdateUserAndParticipantEntity1762249952763'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX \`ix_conferences_start\` ON \`conferences\` (\`start_time\`)`);
        await queryRunner.query(`CREATE INDEX \`ix_conferences_status\` ON \`conferences\` (\`status\`)`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`ix_conferences_uid\` ON \`conferences\` (\`uid\`)`);
